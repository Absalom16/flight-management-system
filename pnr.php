...
$con=mysqli_connect("localhost","root","Rawlings16$","airline_reservation");
if(!isset($con))
{
...
<html>
    ...
    <body  style="background-image:url('images/aeroplane.jpg');background-repeat: no-repeat;
                background-size: 100%;" >
            ...
            <div class="container-fluid">    
                ...
                <div  id="divtop">
                    <center>
                        <br> <br><br>
                            <div id="dmain"  > 
                               <center><h1 style="color: white;">FLYWAY</h1></center>
                                <br>
                                    ...
                                    <button type="button" onclick="location.href = './customer_homepage.php';" class="toggle btn btn-primary" style="width:100px; margin-left: 70px;">Home</button>
                                    <br>
